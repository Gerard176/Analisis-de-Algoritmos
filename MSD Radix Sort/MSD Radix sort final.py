...
datos = pd.read_excel("Vector 1er examen 8 VECTORES.xlsx", sheet_name='Hoja1', header=None) #instanciamos el dataframe

indice_fila_deseada = 15# indicamos la fila a leer del excel

#convertimos la fila de excel al tipo de dato que necesitamos en este caso un array
