...
datos = pd.read_excel("Vector 1er examen 8 VECTORES.xlsx", sheet_name='Hoja1', header=None)

indice_fila_deseada = 2

datos_conjunto = datos.iloc[indice_fila_deseada, 2:]
datos_conjunto = datos_conjunto.values.astype('int64')
array = datos_conjunto.tolist() 
print(array)
...
for digit_pos in range(max_length):
    ...
    for subarray in auxiliar:
        ...
        for indice, num in enumerate(subarray):
...
print("tiempo de ejecucion:",tiempo_transcurrido*1000000, "ms")
print(c)
